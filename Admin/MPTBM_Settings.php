...
?>
		...
		public static function description_array($key)
		{
			$des = array(
				...
				'mptbm_maximum_passenger' => esc_html__('Filters services by the maximum number of passengers allowed', 'ecab-taxi-booking-manager'),
				'mptbm_maximum_bag' => esc_html__('Filters services by the maximum number of bags allowed', 'ecab-taxi-booking-manager'),
				//================//
				...
				'mptbm_waiting_price' => esc_html__('Specifies the price charged per hour for waiting time', 'ecab-taxi-booking-manager'),
				'mptbm_operation_area' => esc_html__('Select the operation area from the list provided', 'ecab-taxi-booking-manager'),
				'mptbm_operation_area_type' => esc_html__("Choose the operation type: \"Single Operation Area\" for local services or \"Intercity Operation Area\" for services spanning multiple cities.", "ecab-taxi-booking-manager"),
